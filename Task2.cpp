    ...
    while (running) {
        if (userRole == "admin"){
            ...
            if (choice == 1) {
                ...
                if (!isValid) {
                    cout << "Invalid input. Please enter a numeric Player ID.\n";
                    continue;
                }

                int withdrawID = stoi(input);
                queue.withdrawPlayer(withdrawID);
            ...
            if (choice == 1) {
                // STEP 1: View My Info (to be implemented next)
            }
            else if (choice == 2) {
                // STEP 2: Check-In (to be implemented)
            }
            else if (choice == 3) {
                // STEP 3: Withdraw from Tournament (to be implemented)
            }
            else if (choice == 4) {
                running = false;
                cout << "Goodbye!\n";
